...
object ChannelRepository {
    // 100% Curated Working Channels under the exact 7 requested categories
    val channels = listOf(
        // 1. Pakistan
        ...
        Channel("pak_10", "PTV Home", "https://ptv-sports-live.ptv.com.pk/live/playlist.m3u8", "https://upload.wikimedia.org/wikipedia/commons/2/23/PTV_Sports_logo.png", "Pakistan", "Pakistan", "LIVE"),
...
object SampleData {
    ...
    val musicChannels = ChannelRepository.channels
}
